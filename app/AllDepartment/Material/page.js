      ...
      <div className="grid grid-cols-2 max-md:grid-cols-1">
        ...
        <div className="px-6 max-sm:px-2 ">
          ...
          <div className="text-justify max-sm:text-[12px]">
            About fdsfdsf sdfjkdsjfdksfj
                <button
                onClick={() => router.push('/AllDepartment/Material/about')}
        ...
        <div className="grid grid-cols-3 max-sm:grid-cols-2 mt-10">
          <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/mission')}
            Title={'MISSION AND VISSION'}
          />
          <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/faculty')}
            Title={'FACULTY'}
          />
          {/* <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/labs')}
            Title={'LABS'}
          /> */}
          <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/syllabus')}
            Title={'SYLLABUS'}
          />
          <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/timeTable')}
            Title={'Time Table'}
          />
          {/* <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/activities')}
            Title={'ACTIVITIES'}
          />
          <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/achivments')}
            Title={'ACHIEVMENTS'}
          />
          <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/research')}
            Title={'RESEARCH HIGHLIGHT'}
          />
          <DepartmentNavigationButton
            onClick={() => router.push('/AllDepartment/Material/usefullLinks')}
            Title={'USEFULL LINKS'}
          /> */}
        </div>
      </div>
