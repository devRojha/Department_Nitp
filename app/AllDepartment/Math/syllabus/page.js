    ...
    <div className="bg-orange-50 flex flex-col p-10 max-sm:p-2">
      ...
      <div className="mb-10 flex space-x-1">
        ...
        <button
          ...
          className={`border border-black rounded ${
            dual ? 'text-white bg-red-900' : 'text-red-900'
          } px-2`}
        >
          Dual Degree
        </button>
      ...
      <div className={`mb-10 ${ug == false ? 'hidden' : ''}`}>
        ...
        <div className="border grid grid-cols-12">
          ...
          <SyallbusComp
            ...
            cred={'3'}
            url={
              'https://web.nitp.ac.in/dept/civil/syllabus/English%20Literature.docx'
            }
          />
          <SyallbusComp
            dep={'CEUG'}
            ...
            cred={'4'}
            url={
              'https://web.nitp.ac.in/dept/civil/syllabus/Engineering%20Mathematics%20I.docx'
            }
          />
          <SyallbusComp
            dep={'CEUG'}
          ...
          <SyallbusComp
            ...
            cred={'1'}
            url={
              'https://web.nitp.ac.in/dept/civil/syllabus/Engineering%20Physics%20Lab.docx'
            }
          />
          <SyallbusComp
            dep={'CEUG'}
            ...
            cred={'3'}
            url={
              'https://web.nitp.ac.in/dept/civil/syllabus/Introduction%20to%20Computing.docx'
            }
          />
          <SyallbusComp
            dep={'CEUG'}
            ...
            cred={'1'}
            url={
              'https://web.nitp.ac.in/dept/civil/syllabus/Computing%20Lab.docx'
            }
          />
          <SyallbusComp
            dep={'CEUG'}
          ...
          <SyallbusComp
            ...
            cred={'1'}
            url={
              'https://web.nitp.ac.in/dept/civil/syllabus/Workshop%20Practice.docx'
            }
          />
          <SyallbusComp
            dep={'CEUG'}
          ...
          <SyallbusComp
            ...
            cred={'2'}
            url={
              'https://web.nitp.ac.in/dept/civil/syllabus/Engineering%20Graphics.docx'
            }
          />
          <SyallbusComp
            dep={'CEUG'}
      ...
      <div className={`mb-10 ${pg == false ? 'hidden' : ''}`}>
        ...
        <div className="border grid grid-cols-12">
          ...
          <SyallbusComp
            ...
            sem=""
            code="CE735"
            title="Earth Pressure and Retaining Structures"
            L="3"
            T="0"
            P="0"
            cred="3"
          ...
          <SyallbusComp
            ...
            sem=""
            code="CE737"
            title="Earth and Rock-fill Dams"
            L="3"
            T="0"
            P="0"
            cred="3"
          ...
          <SyallbusComp
            ...
            sem=""
            code="CE741"
            title="Reinforced Earth and Geotextiles"
            L="3"
            T="0"
            P="0"
            cred="3"
          ...
          <SyallbusComp
            ...
            sem=""
            code="CE743"
            title="Slope Stability and Earthen Dams"
            L="3"
            T="0"
            P="0"
            cred="3"
          ...
          <SyallbusComp
            ...
            sem="2"
            code="CE663"
            title="Advanced Ground Water Engineering"
            L="3"
            T="0"
            P="0"
            cred="3"
      ...
      <div className={`mb-10 ${dual == false ? 'hidden' : ''}`}>
        ...
        <ul className="list-disc list-inside ml-5 space-y-4 text-lg max-md:text-[15px] max-sm:text-sm">
          <li className="hover:text-blue-800">
            <a href="">
              Civil Engineering with Specialization in Construction Technology
              and Management (5 Years, Bachelor and Master of Technology (Dual
              Degree))
            </a>
          </li>
        </ul>
