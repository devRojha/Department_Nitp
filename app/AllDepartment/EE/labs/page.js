...
export default function labs(){
    ...
    return (
        <div className="bg-orange-50 flex flex-col p-10 max-sm:p-2">  
            ...
            {/* Research  */}
            <div className="mb-10">
                <div className=" font-bold text-2xl max-sm:text-1xl mb-8">Research Laboratories</div>
            ...
            <div className="mb-10">
                <div className="text-red-900 font-bold text-2xl max-sm:text-1xl mb-8">1. Advanced Instrumentation Lab:</div>
            ...
            <div className="mb-10">
                <div className="text-red-900 font-bold text-2xl max-sm:text-1xl mb-8">2. Control Lab:</div>
            ...
            <div className="mb-10">
                <div className="text-red-900 font-bold text-2xl max-sm:text-1xl mb-8">3. Industrial Drives and Control Lab:</div>
            ...
            <div className="mb-10">
                <div className="text-red-900 font-bold text-2xl max-sm:text-1xl mb-8">4.SCADA Lab:</div>
            ...
            <div className="mb-10">
                <div className="text-red-900 font-bold text-2xl max-sm:text-1xl mb-8">5. NIT Patna campus smart metered distribution system:</div>
            ...
            <div className="mb-10">
                <div className="text-red-900 font-bold text-2xl max-sm:text-1xl mb-8">6. Power electronics Lab:</div>
