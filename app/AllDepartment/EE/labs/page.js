            ...
            <div className="max-sm:mx-6 max-md:mx-8 mx-20 border p-4 rounded-md shadow-lg shadow-slate-400 backdrop-blur-md">
                <div className="mb-10">
                    ...
                    <div className=" grid grid-cols-2 max-md:grid-cols-1">
                        <ol className="list-decimal list-inside ml-5 space-y-4 text-md max-md:text-[15px] max-sm:text-sm">
                ...
                {/* Research  */}
                <div className="mb-10">
                    <div className=" font-bold text-2xl max-sm:text-1xl mb-4">Research Laboratories</div>
                    <p className="text-justify">The Department of Electrical Engineering has multiple laboratories/facilities which are engaged in interesting and cutting-edge research projects. The details of those laboratories are as follows:</p>
                </div>
                <div className="mb-10">
                    <div className="text-red-900 font-semibold text-2xl max-sm:text-1xl mb-2">1. Advanced Instrumentation Lab:</div>
                    <p className="text-justify">Dr. Arunangshu Ghosh with his team of students is working towards the development of a portable electronic tongue for estimation of tea quality and spoilage detection of food samples. The other work in progress is development of the Potentiostat System for General Purpose Electro-Chemical Applications. These systems are developed to develop automated systems for quality analysis of different agricultural and food samples. Besides, technology using near infrared spectroscopy based development (NIR) is also being carried out for developing non-invasive, portable and optical solutions for quality analysis of food samples. Software like Matlab, LABView, and MPLAB are regularly used to train students for carrying out researches in this lab. Two externally sponsored research projects have been completed successfully in this laboratory.</p>
                </div>
                <div className="mb-10">
                    <div className="text-red-900 font-semibold text-2xl max-sm:text-1xl mb-2">2. Control Lab:</div>
                    <p className="text-justify">A project design and development of low-cost BLDC motor drive for solar PV based irrigation system. One externally sponsored research project has been completed successfully in this laboratory</p>
                </div>
                <div className="mb-10">
                    <div className="text-red-900 font-semibold text-2xl max-sm:text-1xl mb-2">3. Industrial Drives and Control Lab:</div>
                    <p className="text-justify">The group of students led by Dr. Vimlesh Verma works towards the development of control techniques for electrical machine drives. High end hardware simulators like HIL, and software like DSpace are a part of this lab. One externally sponsored research project has been completed successfully in this laboratory.</p>
                </div>
                <div className="mb-10">
                    <div className="text-red-900 font-semibold text-2xl max-sm:text-1xl mb-2">4.SCADA Lab:</div>
                    <p className="text-justify">This space is equipped with the facilities where Interfacing of wind turbines with power systems and realization of hardware of grid using supervisory control can be done by masters and PhD students.</p>
                </div>
                <div className="mb-10">
                    <div className="text-red-900 font-semibold text-2xl max-sm:text-1xl mb-2">5. NIT Patna campus smart metered distribution system:</div>
                    <p className="text-justify">This enables us to get the real time measurement of power, current, frequency, voltage and other electrical parameters throughout the system at different nodes. The dataset created acts as an asset and allows us to work further on load forecasting, demand side management, generation and distribution planning, also renewable generation planning). One externally sponsored research project under Dr. Mala De has been completed successfully in this laboratory.</p>
                </div>
                <div className="mb-10">
                    <div className="text-red-900 font-semibold text-2xl max-sm:text-1xl mb-2">6. Power electronics Lab:</div>
                    <p className="text-justify">A team of students along with Dr. Ambarisha Mishra is working on a six-phase induction motor drive.</p>
                </div>        
            </div>
        </div>
    )
